...
/**
 * This enum class stores relations of this database. Each instance
 * has a name for the relation and the count of the number of the
 * relation's attributes and the count of attributes that compose its
 * primary key.
 * 
 * @author AtoshDustosh
 */
public enum Relations {
  ...
  VehicleColour("VehicleColour", 2, 2),
